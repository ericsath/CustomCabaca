...
import eric.app.cabaca.response.BaseResponse;
import eric.app.cabaca.response.BookResponse;

public class BookAdapter extends RecyclerView.Adapter<BookAdapter.ViewHolder> {
    public static final String TAG = "logv"+BookAdapter.class.getSimpleName();
    private Context context;
    private List<BookResponse.Result> bookResponseList;
    private String cover_url,base_image, key_image;
    private ItemListener itemListener;

    public BookAdapter(Context context, List<BookResponse.Result> bookResponseList, ItemListener itemListener) {
