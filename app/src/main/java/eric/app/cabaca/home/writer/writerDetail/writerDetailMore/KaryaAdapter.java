...
public class KaryaAdapter extends RecyclerView.Adapter<KaryaAdapter.ViewHolder> {
    ...
    private List<WriterDetailResponse.Result.Karya> karyaList;
    private String cover_url,base_image, key_image;
    private ItemListener itemListener;

    public KaryaAdapter(Context context,List<WriterDetailResponse.Result.Karya> karyaList, ItemListener itemListener) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final WriterDetailResponse.Result.Karya item = karyaList.get(position);
    ...
    public interface ItemListener{
        void userClick(WriterDetailResponse.Result.Karya item);
    }
}
