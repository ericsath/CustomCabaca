 ...
 */
public class KaryaFragment extends Fragment implements KaryaAdapter.ItemListener,WriterDetailView {
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager rvLiLayoutManager;
    private CompositeDisposable compositeDisposable;
    private ApiInterface apiInterface;
    private ProgressBar progressBar;
    private KaryaAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_karya, container, false);
    }
    ...
    public void getNewDetailWriter(WriterDetailResponse writerDetailResponse) {
        if (writerDetailResponse.result.getKarya()!=null){
            progressBar.setVisibility(View.GONE);
            adapter = new KaryaAdapter(getActivity(),writerDetailResponse.result.getKarya(),this);
    ...
    @Override
    public void userClick(WriterDetailResponse.Result.Karya item) {
